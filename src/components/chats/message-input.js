...
export default function MessageInput() {
    return (
        <div className="w-full pr-10 flex gap-4">
            ...
            <input type="text" placeholder="Write here..." className="outline-none grow h-full border-b-2 border-primary focus:border-focus" />
            <IoIosSend className="text-white h-full w-[40px] p-2.5 rounded-md bg-navbarBg"/>
        </div>
    )
}
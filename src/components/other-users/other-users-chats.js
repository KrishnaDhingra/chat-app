...
export default function OtherUsersChats() {
    return (
        <div className="chats-container pl-8 pr-6 pt-6 flex flex-col gap-3 h-full w-full  overflow-y-auto">
            ...
            <input placeholder="Search for chats" type="text" className="w-full py-2 px-3 outline-none border border-primary rounded-md focus:border-focus placeholder:text-sm"/>

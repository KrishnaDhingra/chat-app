...
export default function OtherUsersInfo() {
    return (
        <div className="relative w-full h-full flex items-center justify-center flex-col bg-gray-100 bg-transparent">
            <FiSettings className="absolute top-7 right-7"/>
            ...
            <h2 className="text-gray-800 font-semibold">Sachin Dhingra</h2>
